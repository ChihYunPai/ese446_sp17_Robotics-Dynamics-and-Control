###########################################################################
## Makefile generated for Simulink model 'RRR_arm'. 
## 
## Makefile     : RRR_arm.mk
## Generated on : Thu Apr 27 16:22:58 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/RRR_arm
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/tonypai/Dropbox/WUStL/Spring\ 2017/ESE\ 446\ Robotics-Dynamics\ and\ Control/Final\ project/mfile
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = RRR_arm_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/RRR_arm
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/RRR_arm_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=RRR_arm -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/RRR_arm_grt_rtw/RRR_arm.c $(START_DIR)/RRR_arm_grt_rtw/RRR_arm_data.c $(START_DIR)/RRR_arm_grt_rtw/rtGetInf.c $(START_DIR)/RRR_arm_grt_rtw/rtGetNaN.c $(START_DIR)/RRR_arm_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = RRR_arm.o RRR_arm_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_logging.o
...
%.o : $(START_DIR)/RRR_arm_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/RRR_arm_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
